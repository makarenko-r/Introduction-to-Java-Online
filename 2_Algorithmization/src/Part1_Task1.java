public class Part1_Task1 {
    public static void main(String[] args) {
        ...
        System.out.println("Создан массив с " + n + " элементами (значения от 1 до 100000).");
        // Определим случайным образом заданное k в промежутке от 1 до 100
        k = (int) (Math.random()*100+1);
        System.out.println("Заданное число K равно, K = " + k + ".");
