...
public class Part1_Task4 {
    public static void main(String[] args) {
        ...
        arrayCounter = (int) (Math.random()*9+2);       // +2 т.к. n не может быть равным нулю и 1 т.к. нужно поменять местами
        ...
        System.out.println("Создан массив действительных чисел с " + arrayCounter + " элементами в интервале (-10;10).");
